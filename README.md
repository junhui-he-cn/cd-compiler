...
may observe the mutation. Nested/dynamic index targets, loop exit, and
...
`else` branches with both arms falling through, loops, nested fields, and dynamic
indexes remain conservative when no compatible fact is proven on both sides.
