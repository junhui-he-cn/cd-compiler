...
| Language | Functions, closures, generics and constraints, `optional<T>`/`T?`, trailing commas, enums/patterns, named and recursive structs, collection semantics, `Eq`/`Ord`/`Hash` capabilities |
