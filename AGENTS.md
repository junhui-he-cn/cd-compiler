...
- A `while` condition's true-branch nullable narrowing is active while checking its body. The condition facts are scoped to the body and do not survive the loop; C-style `for`, `for-in`, and loop-exit joins remain conservative.
